...
from .models import ArticleCategory, Article, Comment # Add Comment

class ArticleAdmin(admin.ModelAdmin):
    list_display = ('title', 'category', 'author', 'created_on', 'updated_on')
    list_filter = ('category', 'author', 'created_on')
    search_fields = ('title', 'entry')
    readonly_fields = ('created_on', 'updated_on') # Good to show but not edit here
...
class CommentAdmin(admin.ModelAdmin):
    ...
    def entry_short(self, obj): # Display a snippet of the comment
